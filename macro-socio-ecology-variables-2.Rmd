---
title: "Macro-socio-ecology-variables-viz"
...
```{r, fig.width=6, fig.height=5, warning=FALSE, error=FALSE, message=FALSE}
library(ggplot2);library(reshape);library(Hmisc);library(ggvis);library(dplyr)
